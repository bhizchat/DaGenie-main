...
final class CharacterRepository: ObservableObject {
    ...
    func fetchCharacter(id: String) async -> GenCharacter? {
        ...
        let characters: [String: GenCharacter] = [
            ...
            "50": GenCharacter(id: "50", name: "Money Machine 50", defaultImageUrl: "", assetImageUrls: [], localAssetName: "50"),
            ...
            "t8": GenCharacter(id: "t8", name: "The Popstar T8", defaultImageUrl: "", assetImageUrls: [], localAssetName: "T8"),
