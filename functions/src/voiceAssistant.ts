  ...
  try {
    ...
    const systemGuard: ChatMessage = {
      ...
      content: [
        ...
        "Step 1 (alone): Ask only — ‘So who would you say is your target audience for this ad?’ Keep it as that single question (no numbering).",
        ...
        "After the user answers Step 2, briefly acknowledge both answers (audience + CTA) in one sentence, then ask the style preference as a single question:",
